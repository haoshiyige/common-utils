...
describe('ArrayUtils.keyBy', () => {
  it('should map each element of an array by string key', () => {
    ...
    const result = ArrayUtils.keyBy(people, person => person.name);
  ...
  it('should map each element of an array by number key', () => {
    ...
    const result = ArrayUtils.keyBy(people, person => person.age);
  ...
  it('should map each element of an array by symbol key', () => {
    ...
    const result = ArrayUtils.keyBy(people, person => person.id);
